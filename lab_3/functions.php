...
function ValidateContactMethod($contactMethod, $time, &$errors) {
  
    if ($contactMethod == 'phone') {
        if (!isset($time)) {
            $errors['contactMethod'] = 'When preferred contact method is phone, you have to select one or more contact times';
        }
    }
}
